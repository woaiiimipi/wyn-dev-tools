...
export const fileEnum = {
  ...
  // 'en': root + `/src/common/services/i18n/locales/en.json`,
  // 'zh': root + `/src/common/services/i18n/locales/zh.json`,
  // 'zh_TW': root + `/src/common/services/i18n/locales/zh_TW.json`,
